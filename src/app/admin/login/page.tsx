...
import { IconLock, IconUser, IconX, IconAlertTriangle } from '@tabler/icons-react';
import toast from 'react-hot-toast';
import { LoginCredentials } from '@/types/blog';
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (response.status === 401) {
          ...
          showErrorModal(
            'Login Error',
            result.error || 'An unexpected error occurred during login. Please try again.'
          );
        }
