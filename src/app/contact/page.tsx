...
const faqs = [
  {
    ...
    answer: "We offer comprehensive web development, mobile app development, UI/UX design, cloud services, digital marketing, and IT consulting services to help businesses grow digitally."
  },
  {
    question: "How long does a typical project take?",
    answer: "Project timelines vary depending on complexity. A simple website might take 2-4 weeks, while complex applications can take 3-6 months. We'll provide a detailed timeline during our initial consultation."
  },
  {
    question: "Do you provide ongoing support?",
    answer: "Yes, we offer ongoing support and maintenance packages to ensure your solutions continue to perform optimally. This includes updates, security patches, and technical support."
  },
  {
    question: "What is your pricing structure?",
    answer: "Our pricing is project-based and depends on the scope, complexity, and requirements. We provide detailed quotes after understanding your specific needs during the discovery phase."
  },
  {
    question: "Do you work with international clients?",
    answer: "Absolutely! We work with clients worldwide and have experience in various industries and markets. We can accommodate different time zones and communication preferences."
  },
  {
    question: "Can you help with existing projects?",
    answer: "Yes, we can help improve, maintain, or scale existing projects. We'll assess your current setup and provide recommendations for optimization and enhancement."
  }
];
            ...
            >
              <div>
                ...
                <p className="text-gray-300 mb-6">
                  Come visit us at our office in Kathmandu. We'd love to meet you in person and discuss your project over coffee.
                </p>
              </div>
                ...
                <div className="relative -mt-16 mx-4 mb-4">
                  <div className="bg-black/70 backdrop-blur-sm rounded-lg p-4 border border-gray-600/50">
                    <div className="flex items-center justify-between">
                      <div>
                        <h4 className="text-white font-semibold mb-1">Kush Tech Nepal</h4>
                        <p className="text-gray-300 text-sm">Lazimpath-02, Kathmandu</p>
                      </div>
                      <a
