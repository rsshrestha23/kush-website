...
const processSteps = [
  ...
  },
  {
    ...
    description: "We deploy your project to production and ensure everything runs smoothly.",
    icon: "🚀"
  },
  {
    step: "05",
    title: "Support & Maintenance",
    description: "We provide ongoing support, updates, and maintenance to keep your solution running optimally.",
    icon: "🛠️"
  }
];
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              From web development to digital marketing, we provide end-to-end solutions to help your business thrive in the digital age.
            </p>
          </motion.div>
            ...
            {services.map((service, index) => (
              ...
              >
                <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/50 backdrop-blur-sm rounded-2xl p-8 border border-gray-700/50 hover:border-[#004D2C]/50 transition-all duration-300 hover:transform hover:scale-105 h-full">
                  ...
                  <div className="mb-6">
                    <h4 className="text-lg font-semibold mb-3 text-[#004D2C]">Key Features:</h4>
                  ...
                  <div className="mb-6">
                    <h4 className="text-lg font-semibold mb-3 text-[#004D2C]">Technologies:</h4>
                ...
                {processSteps.map((step, index) => (
                  ...
                  >
                    ...
                    <div className="space-y-3">
                      <div className="text-2xl font-bold text-[#004D2C]">{step.step}</div>
            ...
            {processSteps.map((step, index) => (
              ...
              >
                ...
                <div className="flex-1 pt-2">
                  <div className="text-xl font-bold text-[#004D2C] mb-2">{step.step}</div>
            ...
            {[
              {
                icon: "🎯",
                title: "Expert Team",
                description: "Experienced professionals with deep expertise in their respective fields."
              },
              {
                icon: "⚡",
                title: "Fast Delivery",
              ...
              },
              {
                ...
                description: "Rigorous testing and quality control processes to ensure flawless delivery."
              },
              {
                icon: "🤝",
                title: "Ongoing Support",
                description: "Continuous support and maintenance to keep your solutions running optimally."
              }
            ].map((feature, index) => (
              <motion.div
                key={feature.title}
