    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <div className="flex space-x-3">
          ...
          >
            {showPreview ? <IconEyeOff className="w-4 h-4 mr-2" /> : <IconEye className="w-4 h-4 mr-2" />}
          ...
          <div className="mt-1">
            {showPreview ? (
              <div className="border border-gray-300 rounded-md p-4 bg-gray-50 min-h-[400px]">
                <div className="prose max-w-none" dangerouslySetInnerHTML={{ __html: watchedContent }} />
              </div>
            ) : (
              <Controller
                name="content"
