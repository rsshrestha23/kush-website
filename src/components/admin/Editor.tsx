        ...
        <CKEditor
          ...
          onReady={(editor: any) => {
            ...
            editingView.change((writer: any) => {
              ...
              writer.setStyle('font-family', 'system-ui, -apple-system, sans-serif', viewRoot);
              writer.setStyle('line-height', '1.6', viewRoot);
            });

            // Listen for upload progress and errors
            editor.plugins.get('FileRepository').on('uploadTotal', (evt: any, data: any) => {
              console.log('Upload progress:', data);
            });

            editor.plugins.get('FileRepository').on('uploadComplete', (evt: any, { imageElement, data }: any) => {
