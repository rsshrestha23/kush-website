    ...
    content: (
      <div className="flex h-full w-full items-center justify-center bg-[linear-gradient(to_bottom_right,var(--cyan-500),var(--emerald-500))] text-white">
        <div className="text-center">
          ...
          <div className="text-sm mt-2 opacity-90">React • Next.js • TypeScript</div>
        </div>
      </div>
    ),
  },
    ...
    content: (
      <div className="flex h-full w-full items-center justify-center text-white">
        <div className="text-center">
          ...
          <div className="text-sm mt-2 opacity-90">React Native • Flutter • Swift</div>
        </div>
      </div>
    ),
  },
    ...
    content: (
      <div className="flex h-full w-full items-center justify-center bg-[linear-gradient(to_bottom_right,var(--orange-500),var(--yellow-500))] text-white">
        <div className="text-center">
          ...
          <div className="text-sm mt-2 opacity-90">Architecture • Optimization • Growth</div>
        </div>
      </div>
    ),
  },
    ...
    content: (
      <div className="flex h-full w-full items-center justify-center bg-[linear-gradient(to_bottom_right,var(--purple-500),var(--pink-500))] text-white">
        <div className="text-center">
          ...
          <div className="text-sm mt-2 opacity-90">Bootcamps • Workshops • Mentorship</div>
        </div>
      </div>
    ),
  },
    ...
    content: (
      <div className="flex h-full w-full items-center justify-center bg-[linear-gradient(to_bottom_right,var(--indigo-500),var(--blue-500))] text-white">
        <div className="text-center">
          ...
          <div className="text-sm mt-2 opacity-90">Figma • Prototyping • Research</div>
        </div>
      </div>
    ),
  },
    ...
    content: (
      <div className="flex h-full w-full items-center justify-center bg-[linear-gradient(to_bottom_right,var(--teal-500),var(--cyan-500))] text-white">
        <div className="text-center">
          ...
          <div className="text-sm mt-2 opacity-90">AWS • Azure • Kubernetes</div>
        </div>
      </div>
    ),
  },
